...
describe('evaluator trace integration', () => {
    ...
    it('should pass traceId through to assertions when tracing is enabled', async () => {
        ...
        // Run evaluation
        await (0, evaluator_1.evaluate)(testSuite, mockEval, options);
        ...
        expect(mockEval.addResult).toHaveBeenCalledWith(expect.objectContaining({
            success: true,
            score: 1,
        }));
    });
...
//# sourceMappingURL=trace-integration.test.js.map