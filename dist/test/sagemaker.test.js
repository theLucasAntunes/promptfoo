...
const sagemaker_1 = require("../src/providers/sagemaker");
...
describe('SageMakerCompletionProvider', () => {
    ...
    it('should initialize with correct endpoint name', () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('test-endpoint', {
    ...
    it('should handle errors from SageMaker endpoint', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('fail-endpoint', {
    ...
    it('should call SageMaker endpoint with proper request for OpenAI format', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('openai-endpoint', {
    ...
    it('should call SageMaker endpoint with proper request for Llama format', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('llama-endpoint', {
    ...
    it('should call SageMaker endpoint with proper request for HuggingFace format', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('huggingface-endpoint', {
    ...
    it('should call SageMaker endpoint with proper request for custom format', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('custom-endpoint', {
    ...
    it('should use JavaScript expression for response extraction when configured', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('js-extract-endpoint', {
    ...
    it('should extract array data using JavaScript expression paths', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('nested-data-endpoint', {
...
describe('SageMakerEmbeddingProvider', () => {
    it('should initialize with correct endpoint name', () => {
        const provider = new sagemaker_1.SageMakerEmbeddingProvider('embedding-endpoint', {
    ...
    it('should handle errors from embedding endpoint', async () => {
        const provider = new sagemaker_1.SageMakerEmbeddingProvider('fail-endpoint', {
            id: 'sagemaker:fail-endpoint',
        });
        const result = await provider.callEmbeddingApi('test text');
        expect(result.error).toBeDefined();
    ...
    it('should format embedding request according to model type', async () => {
        const openaiProvider = new sagemaker_1.SageMakerEmbeddingProvider('embedding-endpoint', {
            id: 'sagemaker:embedding-endpoint',
            config: {
                modelType: 'openai',
            },
        });
        const huggingfaceProvider = new sagemaker_1.SageMakerEmbeddingProvider('embedding-endpoint', {
            id: 'sagemaker:embedding-endpoint',
            config: {
                modelType: 'huggingface',
            },
...
describe('SageMaker Provider Registry', () => {
    it('should load SageMaker completion provider', async () => {
        const provider = await (0, index_1.loadApiProvider)('sagemaker:my-endpoint', {
            options: {
    ...
    it('should load SageMaker embedding provider', async () => {
        const provider = await (0, index_1.loadApiProvider)('sagemaker:embedding:my-embedding-endpoint');
        expect(provider).toBeDefined();
        expect(provider.id()).toBe('sagemaker:my-embedding-endpoint');
    });
    it('should load SageMaker provider with model type', async () => {
        const provider = await (0, index_1.loadApiProvider)('sagemaker:openai:my-openai-endpoint', {
            options: {
    ...
    it('should load provider with custom configuration options', async () => {
        ...
        const provider = await (0, index_1.loadApiProvider)('sagemaker:my-custom-endpoint', context);
        expect(provider).toBeDefined();
...
describe('SageMakerCompletionProvider - Payload Formatting', () => {
    ...
    describe('formatPayload method', () => {
        ...
        it('should format JumpStart payload correctly', () => {
            const provider = new sagemaker_1.SageMakerCompletionProvider('jumpstart-endpoint', {
...
describe('SageMakerCompletionProvider - Parameter Validation', () => {
    ...
    it('should handle provider initialization with minimal config', () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('minimal-endpoint', {
    ...
    it('should override endpoint name from config', () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('original-endpoint', {
    ...
    describe('should validate supported model types', () => {
        ...
        it('Should throw an error if the model type within the provider ID is not supported', () => {
            expect(() => {
                new sagemaker_1.SageMakerCompletionProvider('test-endpoint', {
                    id: 'sagemaker:invalid:test-endpoint',
                });
            }).toThrow('Invalid model type "invalid" in provider ID. Valid types are: openai, llama, huggingface, jumpstart, custom');
        });
        it('Should throw an error if no model type is provided', () => {
            ...
            }).toThrow('Model type must be set either in `config.modelType` or as part of the Provider ID, for example: "sagemaker:<model_type>:<endpoint>"');
        });
    });
    it('should handle delay configuration from context', async () => {
        const provider = new sagemaker_1.SageMakerCompletionProvider('delay-endpoint', {
...
describe('SageMakerEmbeddingProvider - Extended Tests', () => {
    ...
    it('should format embedding payload for custom model type with multiple input formats', async () => {
        const provider = new sagemaker_1.SageMakerEmbeddingProvider('custom-embedding-endpoint', {
    ...
    it('should apply transformation to embedding text before processing', async () => {
        const provider = new sagemaker_1.SageMakerEmbeddingProvider('transform-embedding-endpoint', {
...
//# sourceMappingURL=sagemaker.test.js.map