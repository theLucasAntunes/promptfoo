...
describe('matchesContextFaithfulness', () => {
    ...
    it('should pass when the faithfulness score is above the threshold', async () => {
        ...
        await expect((0, matchers_1.matchesContextFaithfulness)(query, output, context, threshold)).resolves.toEqual({
            pass: true,
    ...
    it('tracks token usage for multiple API calls', async () => {
        ...
        const context = 'Context text';
        const threshold = 0.5;
        const result = await (0, matchers_1.matchesContextFaithfulness)(query, output, context, threshold);
    ...
    describe('Array Context Support', () => {
        it('should handle array of context chunks', async () => {
            ...
            const threshold = 0.5;
            const result = await (0, matchers_1.matchesContextFaithfulness)(query, output, contextChunks, threshold);
...
//# sourceMappingURL=context-faithfulness.test.js.map