...
describe('generatePersonasPrompt', () => {
    it('should generate a prompt for a single prompt input', () => {
        ...
        const numPersonas = 3;
        const result = (0, synthesis_1.generatePersonasPrompt)(prompts, numPersonas);
...
describe('testCasesPrompt', () => {
    it('should generate a test cases prompt with single prompt and no existing tests', () => {
        ...
        const result = (0, synthesis_1.testCasesPrompt)(prompts, persona, tests, numTestCasesPerPersona, variables);
        expect(result).toBe((0, dedent_1.default) `
    ...
    it('should generate a test cases prompt with multiple prompts and existing tests', () => {
        ...
        const result = (0, synthesis_1.testCasesPrompt)(prompts, persona, tests, numTestCasesPerPersona, variables, instructions);
        expect(result).toBe((0, dedent_1.default) `
