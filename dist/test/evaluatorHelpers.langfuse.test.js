...
const langfuseIntegration = __importStar(require("../src/integrations/langfuse"));
...
describe('renderPrompt - Langfuse integration', () => {
    ...
    describe('version-based prompts', () => {
        it('should handle langfuse:// prompt with version only', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { name: 'World' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('test-prompt', { name: 'World' }, 'text', 3, undefined);
        ...
        it('should handle langfuse:// prompt with version and type', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { topic: 'AI' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('chat-prompt', { topic: 'AI' }, 'chat', 2, undefined);
        ...
        it('should handle latest version keyword', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, {}, {});
    ...
    describe('label-based prompts', () => {
        it('should handle langfuse:// prompt with label only', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { env: 'prod' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('my-prompt', { env: 'prod' }, 'text', undefined, 'production');
        ...
        it('should handle langfuse:// prompt with label and type', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { user: 'Alice' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('chat-prompt', { user: 'Alice' }, 'chat', undefined, 'staging');
        ...
        it('should handle custom environment labels', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { feature: 'new' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('feature-prompt', { feature: 'new' }, 'text', undefined, 'dev');
        ...
        it('should handle tenant-specific labels', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { tenant: 'A' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('multi-tenant', { tenant: 'A' }, 'chat', undefined, 'tenant-a');
        ...
        it('should handle experiment labels', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { variant: 'B' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('ab-test', { variant: 'B' }, 'text', undefined, 'experiment-b');
    ...
    describe('edge cases', () => {
        it('should handle prompt ID with @ symbol correctly with improved parsing', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, {}, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('email@support', {}, 'text', undefined, 'production');
        ...
        it('should handle prompt ID with multiple @ symbols', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, {}, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('user@domain@example', {}, 'chat', undefined, 'staging');
        ...
        it('should handle prompt ID with colon', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, {}, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('namespace:prompt', {}, 'chat', undefined, 'staging');
            expect(result).toBe('Prompt with : in ID');
        });
        ...
        it('should handle errors from Langfuse', async () => {
            ...
            await expect((0, evaluatorHelpers_1.renderPrompt)(prompt, {}, {})).rejects.toThrow('Prompt not found');
        });
    ...
    describe('prompt type variations', () => {
        it('should handle text type with label', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, {}, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('text-example', {}, 'text', undefined, 'production');
        ...
        it('should handle chat type with label', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { question: 'What is AI?' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('chat-example', { question: 'What is AI?' }, 'chat', undefined, 'staging');
    ...
    describe('dual syntax support', () => {
        ...
        it('should auto-detect string as label with : syntax and type', async () => {
            ...
            const prompt = toPrompt('langfuse://chat-prompt:staging:chat');
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { user: 'Bob' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('chat-prompt', { user: 'Bob' }, 'chat', undefined, 'staging');
        ...
        it('should handle tenant labels with : syntax', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { tenant: 'A' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('multi-tenant', { tenant: 'A' }, 'text', undefined, 'tenant-a');
        ...
        it('should handle experiment labels with : syntax', async () => {
            ...
            const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, { variant: 'B' }, {});
            expect(mockGetPrompt).toHaveBeenCalledWith('ab-test', { variant: 'B' }, 'chat', undefined, 'experiment-b');
            expect(result).toBe('Experiment B via colon');
        });
    });
});
//# sourceMappingURL=evaluatorHelpers.langfuse.test.js.map