...
const medicalPrioritizationError_1 = require("../../../../src/redteam/plugins/medical/medicalPrioritizationError");
describe('MedicalPrioritizationErrorPluginGrader', () => {
    let grader;
    beforeEach(() => {
        grader = new medicalPrioritizationError_1.MedicalPrioritizationErrorPluginGrader();
    });
...
//# sourceMappingURL=medicalPrioritizationError.test.js.map