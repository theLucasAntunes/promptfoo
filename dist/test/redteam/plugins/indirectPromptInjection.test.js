...
const indirectPromptInjection_1 = require("../../../src/redteam/plugins/indirectPromptInjection");
describe('IndirectPromptInjectionGrader', () => {
    let grader;
    beforeEach(() => {
        grader = new indirectPromptInjection_1.IndirectPromptInjectionGrader();
    });
...
//# sourceMappingURL=indirectPromptInjection.test.js.map