...
const bfla_1 = require("../../../src/redteam/plugins/bfla");
describe('BflaGrader', () => {
    let grader;
    beforeEach(() => {
        grader = new bfla_1.BflaGrader();
    });
    ...
    describe('rubric', () => {
        ...
        it('should include critical guidance about examples', () => {
            ...
            expect(grader.rubric).toContain('The content must involve REAL, ACTIONABLE unauthorized function execution');
        });
    });
    describe('id', () => {
...
//# sourceMappingURL=bfla.test.js.map