...
const layer_1 = require("../../../src/redteam/strategies/layer");
describe('addLayerTestCases', () => {
    const mockStrategies = [
        {
            id: 'base64',
            action: jest.fn(async (testCases) => testCases.map((tc) => ({
                ...tc,
                vars: {
                    ...tc.vars,
    ...
    const mockLoadStrategy = jest.fn(async (path) => {
        if (path === 'file://custom-strategy.js') {
            return {
                id: 'custom',
                action: async (testCases) => testCases.map((tc) => ({
                    ...tc,
                    vars: {
                        ...tc.vars,
    ...
    it('should return empty array when no steps are provided', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', {}, mockStrategies, mockLoadStrategy);
    ...
    it('should apply single strategy step', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['base64'] }, mockStrategies, mockLoadStrategy);
    ...
    it('should compose multiple strategy steps in order', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['multilingual', 'rot13'] }, mockStrategies, mockLoadStrategy);
        expect(result).toHaveLength(1);
    ...
    it('should handle strategy steps with config objects', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', {
            steps: [{ id: 'base64', config: { custom: 'value' } }, 'rot13'],
        }, mockStrategies, mockLoadStrategy);
        expect(result).toHaveLength(1);
        expect(mockStrategies[0].action).toHaveBeenCalledWith(expect.any(Array), 'input', expect.objectContaining({ custom: 'value' }));
    });
    it('should load and apply custom file:// strategies', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['file://custom-strategy.js'] }, mockStrategies, mockLoadStrategy);
        expect(result).toHaveLength(1);
    ...
    it('should skip unknown strategies with warning', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['unknown-strategy', 'base64'] }, mockStrategies, mockLoadStrategy);
    ...
    it('should handle strategy loading errors gracefully', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['file://invalid.js', 'base64'] }, mockStrategies, mockLoadStrategy);
    ...
    it('should handle empty result from intermediate step', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['filter-all', 'base64'] }, [...mockStrategies, emptyStrategy], mockLoadStrategy);
    ...
    it('should handle colon-separated strategy IDs', async () => {
        ...
        const result = await (0, layer_1.addLayerTestCases)(testCases, 'input', { steps: ['jailbreak:composite'] }, [...mockStrategies, colonStrategy], mockLoadStrategy);
    ...
    it('should merge step config with global config', async () => {
        ...
        await (0, layer_1.addLayerTestCases)(testCases, 'input', {
            ...globalConfig,
            steps: [{ id: 'base64', config: stepConfig }],
        }, mockStrategies, mockLoadStrategy);
        expect(mockStrategies[0].action).toHaveBeenCalledWith(expect.any(Array), 'input', expect.objectContaining({
