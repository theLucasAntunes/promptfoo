...
const custom_1 = require("../../../src/redteam/strategies/custom");
describe('addCustom', () => {
    const mockTestCases = [
        {
    ...
    describe('with simple custom strategy ID', () => {
        it('should process test cases with basic custom strategy', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom');
    ...
    describe('with compound custom strategy ID', () => {
        it('should process test cases with custom:aggressive strategy', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:aggressive');
            expect(result).toHaveLength(2);
            // Check first test case
            expect(result[0]).toEqual({
                vars: { query: 'Tell me a joke' },
        ...
        it('should process test cases with custom:greeting-strategy', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:greeting-strategy');
            expect(result).toHaveLength(2);
    ...
    describe('variant extraction', () => {
        it('should extract simple variant correctly', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:simple');
        ...
        it('should extract complex variant with hyphens', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:multi-word-variant');
            expect(typeof result[0].provider).toBe('object');
            const provider = result[0].provider;
        ...
        it('should handle variant with underscores', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:snake_case_variant');
            expect(typeof result[0].provider).toBe('object');
            const provider = result[0].provider;
    ...
    describe('config merging', () => {
        it('should merge provided config with strategy defaults', () => {
            ...
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, customConfig, 'custom:test');
            expect(typeof result[0].provider).toBe('object');
            const provider = result[0].provider;
        ...
        it('should handle empty config', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, {}, 'custom:minimal');
            expect(typeof result[0].provider).toBe('object');
            const provider = result[0].provider;
            expect(provider.config).toEqual({
                injectVar: 'query',
    ...
    describe('edge cases', () => {
        it('should handle test cases without assertions', () => {
            const testCasesWithoutAssertions = [
                {
                    vars: { query: 'Test query' },
                    metadata: { pluginId: 'test', originalText: 'Test query' },
                },
            ];
            const result = (0, custom_1.addCustom)(testCasesWithoutAssertions, injectVar, config, 'custom:test');
        ...
        it('should handle test cases with multiple assertions', () => {
            const testCasesWithMultipleAssertions = [
                {
                    vars: { query: 'Test query' },
                    assert: [
            ...
            const result = (0, custom_1.addCustom)(testCasesWithMultipleAssertions, injectVar, config, 'custom:multi');
        ...
        it('should preserve most metadata, add strategy metadata, and set originalText from inject variable', () => {
            ...
            const result = (0, custom_1.addCustom)(testCasesWithMetadata, injectVar, config, 'custom:preserve');
    ...
    describe('provider ID generation', () => {
        ...
        it('should generate correct provider ID for compound custom', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:variant');
            expect(typeof result[0].provider).toBe('object');
            const provider = result[0].provider;
            expect(provider.id).toBe('promptfoo:redteam:custom:variant');
        });
        it('should handle complex variant names in provider ID', () => {
            const result = (0, custom_1.addCustom)(mockTestCases, injectVar, config, 'custom:complex-variant-name');
            expect(typeof result[0].provider).toBe('object');
            const provider = result[0].provider;
