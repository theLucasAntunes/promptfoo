...
const mockedFetchWithProxy = jest.mocked(index_1.fetchWithProxy);
describe('ArgsSchema', () => {
    it('`config` and `target` are mutually exclusive', () => {
        ...
        const { success, error } = discover_1.ArgsSchema.safeParse(args);
...
describe('normalizeTargetPurposeDiscoveryResult', () => {
    it('should handle null-like values', () => {
        const result = (0, discover_1.normalizeTargetPurposeDiscoveryResult)({
            purpose: null,
            limitations: '',
            user: 'null',
            tools: [],
...
describe('doTargetPurposeDiscovery', () => {
    ...
    it('should handle empty prompt', async () => {
        ...
        mockedFetchWithProxy.mockImplementation(() => Promise.resolve(new Response(JSON.stringify(mockResponses.shift()), {
            status: 200,
        ...
        const discoveredPurpose = await (0, discover_1.doTargetPurposeDiscovery)(target);
    ...
    it('should render the prompt if passed in', async () => {
        ...
        const discoveredPurpose = await (0, discover_1.doTargetPurposeDiscovery)(target, prompt);
