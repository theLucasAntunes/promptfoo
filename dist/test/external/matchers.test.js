...
const deepeval_1 = require("../../src/external/matchers/deepeval");
...
describe('matchesConversationRelevance', () => {
    ...
    it('should return pass=true for relevant responses', async () => {
        ...
        const result = await (0, deepeval_1.matchesConversationRelevance)(messages, 0.5);
    ...
    it('should consider conversation context', async () => {
        ...
        const mockProvider = {
            ...
            callApi: jest.fn().mockResolvedValue({
                output: JSON.stringify({
                    verdict: 'yes',
                    reason: 'Response directly answers the population question with context from previous message about Paris',
                }),
                tokenUsage: { total: 10, prompt: 5, completion: 5, cached: 0 },
            }),
        };
    ...
    it('should use custom rubric prompt when provided', async () => {
        ...
        await (0, deepeval_1.matchesConversationRelevance)(messages, 0.5, { messages }, { rubricPrompt: customRubric });
        const prompt = mockProvider.callApi.mock.calls[0][0];
    ...
    it('should handle custom variables', async () => {
        ...
        await (0, deepeval_1.matchesConversationRelevance)(messages, 0.5, vars);
        const prompt = mockProvider.callApi.mock.calls[0][0];
        expect(prompt).toContain('What is the capital of France?');
