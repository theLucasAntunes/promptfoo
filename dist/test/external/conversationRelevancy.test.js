...
const deepeval_2 = require("../../src/external/matchers/deepeval");
const conversationRelevancyTemplate_1 = require("../../src/external/matchers/conversationRelevancyTemplate");
...
describe('ConversationRelevancyTemplate', () => {
    describe('generateVerdicts', () => {
        it('should generate proper verdict prompt', () => {
            ...
            const prompt = conversationRelevancyTemplate_1.ConversationRelevancyTemplate.generateVerdicts(messages);
    ...
    describe('generateReason', () => {
        it('should generate proper reason prompt', () => {
            ...
            const prompt = conversationRelevancyTemplate_1.ConversationRelevancyTemplate.generateReason(score, irrelevancies);
...
describe('matchesConversationRelevance with template', () => {
    ...
    it('should use ConversationRelevancyTemplate for prompts', async () => {
        ...
        jest.mocked(defaults_1.getDefaultProviders).mockResolvedValue({
        ...
        await (0, deepeval_2.matchesConversationRelevance)(messages, 0.5);
...
describe('handleConversationRelevance with reason generation', () => {
    it('should generate comprehensive reason when there are irrelevancies', async () => {
        ...
        const mockProvider = {
            id: () => 'mock-provider',
            callApi: jest.fn().mockImplementation(async (prompt) => {
                callCount++;
...
//# sourceMappingURL=conversationRelevancy.test.js.map