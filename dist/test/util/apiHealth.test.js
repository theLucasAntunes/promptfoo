...
describe('API Health Utilities', () => {
    ...
    describe('getRemoteHealthUrl', () => {
        ...
        it('should use custom URL when provided', () => {
            ...
            expect((0, remoteGeneration_1.getRemoteHealthUrl)()).toBe('https://custom-api.example.com/health');
        });
        it('should use cloud config when enabled', () => {
            ...
            expect((0, remoteGeneration_1.getRemoteHealthUrl)()).toBe('https://cloud.example.com/health');
        });
    ...
    describe('checkRemoteHealth', () => {
        it('should return OK status when API is healthy', async () => {
            ...
            const result = await (0, apiHealth_1.checkRemoteHealth)('https://test.api/health');
        ...
        it('should handle errors with cause but no ECONNREFUSED code', async () => {
            const errorWithCause = new Error('Some network error');
        ...
        it('should handle errors with code property but no cause', async () => {
            const errorWithCode = new Error('Connection error');
        ...
        it('should handle errors with both code and cause', async () => {
            const complexError = new Error('Complex network failure');
...
//# sourceMappingURL=apiHealth.test.js.map