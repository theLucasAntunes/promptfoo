...
describe('TokenUsageTracker', () => {
    let tracker;
    beforeEach(() => {
        tracker = tokenUsage_1.TokenUsageTracker.getInstance();
    ...
    it('should handle undefined token usage', () => {
        ...
        expect(tracker.getProviderUsage('test-provider')).toEqual(expect.objectContaining({ numRequests: 1 }));
    });
...
//# sourceMappingURL=tokenUsage.test.js.map