...
const convertEvalResultsToTable_1 = require("../../src/util/convertEvalResultsToTable");
describe('convertResultsToTable', () => {
    it('should convert results to table format', () => {
        ...
        const result = (0, convertEvalResultsToTable_1.convertResultsToTable)(resultsFile);
...
//# sourceMappingURL=convertEvalResultsToTable.test.js.map