...
const exportToFile_1 = require("../../../src/util/exportToFile");
const getHeaderForTable_1 = require("../../../src/util/exportToFile/getHeaderForTable");
describe('exportToFile utils', () => {
    describe('getHeaderForTable', () => {
        it('should extract vars from defaultTest', () => {
            ...
            const result = (0, getHeaderForTable_1.getHeaderForTable)(eval_);
    ...
    describe('convertEvalResultToTableCell', () => {
        it('should handle successful assertion result', () => {
            ...
            const output = (0, exportToFile_1.convertEvalResultToTableCell)(result);
    ...
    describe('convertTestResultsToTableRow', () => {
        it('should convert results to table row', () => {
            ...
            const row = (0, exportToFile_1.convertTestResultsToTableRow)(results, varsForHeader);
