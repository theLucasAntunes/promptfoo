...
const _Grader = new utils_1.TestGrader();
describe('runAssertions', () => {
    ...
    it('should construct proper return shape for stored grader result', async () => {
        ...
        expect(result.componentResults[0].metadata).toEqual(expect.objectContaining({
            pluginId: 'medical:prioritization-error',
            strategyId: 'crescendo',
        }));
    });
});
//# sourceMappingURL=runAssertions.test.js.map