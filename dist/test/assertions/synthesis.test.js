...
describe('synthesize', () => {
    it('should generate assertions based on config prompts and existing assertions', async () => {
            ...
            callApi: jest.fn(() => {
                if (i === 0) {
                    ...
                    return Promise.resolve({
                        output: '{"questions": [{"label": "metric1", "question" : "test question", "question_source": "IMPLIED_IN_INSTRUCTIONS", "question_type": "CORE_FOR_APPLICATION" }]}',
                    });
                }
        ...
        const result = await (0, synthesis_1.synthesize)({
...
describe('generateNewQuestionsPrompt', () => {
    it('should generate a prompt that uses multiple system prompts and all assertions', () => {
        ...
        const result = (0, synthesis_1.generateNewQuestionsPrompt)(prompts, testCases, 1);
        expect(result).toBe((0, dedent_1.default) `
...
describe('convertQuestionToPythonPrompt', () => {
    it('should generate a prompt that uses multiple system prompts and all assertions', () => {
        const result = (0, synthesis_1.convertQuestionToPythonPrompt)(['What is the capital of France?', 'What is the capital of Germany?'], 'Is the response clear?');
        expect(result).toBe((0, dedent_1.default) `
