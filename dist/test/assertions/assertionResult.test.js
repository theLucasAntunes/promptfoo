...
const assertionsResult_1 = require("../../src/assertions/assertionsResult");
describe('AssertionsResult', () => {
    ...
    beforeEach(() => {
        assertionsResult = new assertionsResult_1.AssertionsResult();
    });
    ...
    it('handles PROMPTFOO_SHORT_CIRCUIT_TEST_FAILURES', () => {
        ...
        expect(() => assertionsResult.addResult({
            index: 0,
            result: failingResult,
    ...
    it('respects succeeding threshold', async () => {
        const threshold = 0.5;
        assertionsResult = new assertionsResult_1.AssertionsResult({ threshold });
        assertionsResult.addResult({
            index: 0,
            result: succeedingResult,
        });
    ...
    it('can use a parentAssertionSet', () => {
        ...
        assertionsResult = new assertionsResult_1.AssertionsResult({ parentAssertionSet });
    ...
    describe('noAssertsResult', () => {
        it('returns correct value', () => {
            expect(assertionsResult_1.AssertionsResult.noAssertsResult()).toEqual({
                pass: true,
                score: 1,
    ...
    it('handles redteam guardrails', async () => {
        ...
        expect(result.reason).toBe(assertionsResult_1.GUARDRAIL_BLOCKED_REASON);
    });
    ...
    it('handles invalid scoring function return value', async () => {
        ...
        expect(result.pass).toBe(false);
        expect(result.score).toBe(0);
        expect(result.reason).toBe('Scoring function error: assertion scoring function must return a GradingResult');
    });
...
//# sourceMappingURL=assertionResult.test.js.map