...
describe('Python file references', () => {
    beforeEach(() => {
        ...
        jest.mocked(wrapper_1.runPythonCode).mockReset();
        jest.mocked(pythonUtils_1.runPython).mockReset();
    ...
    it('should map snake_case keys from python dataclass to camelCase', async () => {
        ...
        jest.mocked(pythonUtils_1.runPython).mockResolvedValueOnce(pythonResult);
        const fileAssertion = {
            type: 'python',
            value: 'file:///path/to/assert.py',
        };
