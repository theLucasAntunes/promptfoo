...
describe('AssertionsResult', () => {
    ...
    describe('noAssertsResult', () => {
        it('should return default result for no assertions', () => {
            const result = assertionsResult_1.AssertionsResult.noAssertsResult();
            expect(result).toEqual({
                pass: true,
                score: 1,
                reason: 'No assertions',
                tokensUsed: assertionsResult_1.DEFAULT_TOKENS_USED,
            });
        });
    });
    describe('addResult', () => {
        it('should add result and update totals', () => {
            const assertionsResult = new assertionsResult_1.AssertionsResult({});
            const result = {
                pass: true,
                score: 0.8,
                reason: 'Test passed',
    ...
    describe('testResult', () => {
        it('should calculate final result with threshold', async () => {
            const assertionsResult = new assertionsResult_1.AssertionsResult({ threshold: 0.7 });
            assertionsResult.addResult({
                index: 0,
                result: {
                    pass: true,
    ...
    describe('parentAssertionSet', () => {
        it('should return parent assertion set', () => {
            ...
            const assertionsResult = new assertionsResult_1.AssertionsResult({ parentAssertionSet: parentSet });
            expect(assertionsResult.parentAssertionSet).toBe(parentSet);
        });
    });
});
//# sourceMappingURL=assertionsResult.test.js.map