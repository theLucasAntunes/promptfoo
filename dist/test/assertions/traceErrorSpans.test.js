...
const traceErrorSpans_1 = require("../../src/assertions/traceErrorSpans");
const mockProvider = {
    id: () => 'mock',
    callApi: async () => ({ output: 'mock' }),
};
const mockTraceDataWithErrors = {
...
describe('handleTraceErrorSpans', () => {
    it('should pass when no errors exist and max_count is 0', () => {
        ...
        const result = (0, traceErrorSpans_1.handleTraceErrorSpans)(params);
    ...
    it('should fail when errors exceed max_count', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: 'Found 4 error spans, expected at most 2. Errors: api.call (Internal Server Error), database.query, cache.get and 1 more',
            assertion: params.assertion,
        });
    });
    it('should detect errors by status code', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: 'Found 2 error spans, expected at most 0. Errors: api.call (status: 500), api.call (status: 403)',
            assertion: params.assertion,
        });
    });
    ...
    it('should handle simple number value for backwards compatibility', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: 'Found 4 error spans, expected at most 1. Errors: api.call (Internal Server Error), database.query, cache.get and 1 more',
            assertion: params.assertion,
        });
    });
    it('should detect errors by status message', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: 'Found 2 error spans, expected at most 0. Errors: op1 (Operation failed due to timeout), op2 (Exception: NullPointerException)',
            assertion: params.assertion,
        });
    });
    it('should fail when no trace data is available', () => {
        ...
        expect(() => (0, traceErrorSpans_1.handleTraceErrorSpans)(params)).toThrow('No trace data available for trace-error-spans assertion');
    });
    ...
    it('should default to max_count 0 when no value specified', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: 'Found 4 error spans, expected at most 0. Errors: api.call (Internal Server Error), database.query, cache.get and 1 more',
            assertion: params.assertion,
        });
    });
...
//# sourceMappingURL=traceErrorSpans.test.js.map