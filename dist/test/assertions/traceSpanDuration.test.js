...
const traceSpanDuration_1 = require("../../src/assertions/traceSpanDuration");
const mockProvider = {
    id: () => 'mock',
...
describe('handleTraceSpanDuration', () => {
    it('should pass when all spans are within duration limit', () => {
        ...
        const result = (0, traceSpanDuration_1.handleTraceSpanDuration)(params);
    ...
    it('should fail when some spans exceed duration limit', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: '2 span(s) exceed duration threshold 1000ms. Slowest: api.external (3000ms), llm.chat (1200ms)',
            assertion: params.assertion,
        });
    });
    ...
    it('should check percentile duration when specified', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: '90th percentile duration (3000ms) exceeds threshold 2000ms. Slowest spans: api.external (3000ms)',
            assertion: params.assertion,
        });
    });
    ...
    it('should fail when no trace data is available', () => {
        ...
        expect(() => (0, traceSpanDuration_1.handleTraceSpanDuration)(params)).toThrow('No trace data available for trace-span-duration assertion');
    });
    it('should show top 3 slowest spans when limit exceeded', () => {
        ...
        expect(result).toEqual({
            pass: false,
            score: 0,
            reason: '3 span(s) exceed duration threshold 100ms. Slowest: api.external (3000ms), llm.chat (1200ms), llm.completion (500ms)',
            assertion: params.assertion,
        });
    });
    it('should throw error for invalid value format', () => {
        ...
        expect(() => (0, traceSpanDuration_1.handleTraceSpanDuration)(params)).toThrow('trace-span-duration assertion must have a value object with max property');
    });
...
//# sourceMappingURL=traceSpanDuration.test.js.map