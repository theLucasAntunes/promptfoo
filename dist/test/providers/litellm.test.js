...
const litellm_1 = require("../../src/providers/litellm");
describe('LiteLLM Provider', () => {
    describe('createLiteLLMProvider', () => {
        it('should create a chat provider by default', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:gpt-4', {});
            expect(provider).toBeInstanceOf(litellm_1.LiteLLMProvider);
        });
        it('should create a chat provider when explicitly specified', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:chat:gpt-4', {});
            expect(provider).toBeInstanceOf(litellm_1.LiteLLMProvider);
        });
        it('should create a completion provider', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:completion:gpt-3.5-turbo-instruct', {});
        ...
        it('should create an embedding provider', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:embedding:text-embedding-3-small', {});
            // Check that it has the right methods and identity
        ...
        it('should support embeddings alias', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:embeddings:text-embedding-3-small', {});
            // Check that it has the right methods and identity
            expect(provider.id()).toBe('litellm:embedding:text-embedding-3-small');
            expect(provider.toString()).toContain('LiteLLM Provider embedding');
        });
        ...
        it('should handle model names with colons', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:chat:custom:model:v1', {});
            expect(provider).toBeInstanceOf(litellm_1.LiteLLMProvider);
        ...
        describe('Config handling', () => {
            it('should not override default apiBaseUrl with falsy values', () => {
                const provider1 = (0, litellm_1.createLiteLLMProvider)('litellm:chat:gpt-4', {
                    config: {
                        config: {
                            apiBaseUrl: null,
                        },
                ...
                const provider2 = (0, litellm_1.createLiteLLMProvider)('litellm:chat:gpt-4', {
                    config: {
                        config: {
                ...
                const provider3 = (0, litellm_1.createLiteLLMProvider)('litellm:chat:gpt-4', {
                    config: {
                        config: {
                            apiBaseUrl: '',
                        },
    ...
    describe('Embedding Provider Functionality', () => {
        ...
        it('should be recognized as a valid embedding provider', () => {
            ...
            const isValidEmbeddingProvider = 'callEmbeddingApi' in provider || 'callSimilarityApi' in provider;
        ...
        it('should handle model names with colons for embedding providers', () => {
            const provider = (0, litellm_1.createLiteLLMProvider)('litellm:embedding:custom:embedding:model:v1', {});
