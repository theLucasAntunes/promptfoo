...
const snowflake_1 = require("../../src/providers/snowflake");
jest.mock('../../src/cache', () => ({
...
const mockFetchWithCache = jest.mocked(require('../../src/cache').fetchWithCache);
describe('Snowflake Cortex Provider', () => {
    ...
    describe('initialization', () => {
        it('should initialize with accountIdentifier from config', () => {
            const provider = new snowflake_1.SnowflakeCortexProvider('mistral-large2', {
                config: {
        ...
        it('should initialize with accountIdentifier from environment', () => {
            ...
            const provider = new snowflake_1.SnowflakeCortexProvider('claude-3-5-sonnet', {
                config: {
                    apiKey: 'test-key',
                },
            });
        ...
        it('should throw error when accountIdentifier is not provided', () => {
            expect(() => {
                new snowflake_1.SnowflakeCortexProvider('mistral-large2', {
                    config: {
                        apiKey: 'test-key',
                    },
                });
    ...
    describe('callApi', () => {
        ...
        it('should call Snowflake Cortex API with correct endpoint', async () => {
            ...
            expect(mockFetchWithCache).toHaveBeenCalledWith('https://myorg-myaccount.snowflakecomputing.com/api/v2/cortex/inference:complete', expect.objectContaining({
                method: 'POST',
