...
describe('HyperbolicAudioProvider', () => {
    ...
    it('should create provider with default model', () => {
        const provider = new audio_1.HyperbolicAudioProvider('');
        expect(provider.modelName).toBe('Melo-TTS');
    });
    it('should create provider with specified model', () => {
        const provider = new audio_1.HyperbolicAudioProvider('melo');
    ...
    describe('createHyperbolicAudioProvider', () => {
        it('should create provider with default model', () => {
            const provider = (0, audio_1.createHyperbolicAudioProvider)('hyperbolic:audio');
            expect(provider.modelName).toBe('Melo-TTS');
        });
        it('should create provider with specified model', () => {
            const provider = (0, audio_1.createHyperbolicAudioProvider)('hyperbolic:audio:melo');
            expect(provider.modelName).toBe('melo');
        });
