...
const processor_1 = require("../../../src/providers/responses/processor");
// Mock dependencies
...
describe('ResponsesProcessor', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        processor = new processor_1.ResponsesProcessor({
            modelName: 'gpt-4.1',
            providerType: 'openai',
    ...
    describe('processResponseOutput', () => {
        ...
        it('should process function calls', async () => {
            ...
            expect(mockFunctionCallbackHandler.processCalls).toHaveBeenCalledWith(mockData.output[0], undefined);
        });
    ...
    describe('Provider-specific behavior', () => {
        it('should work with Azure provider configuration', async () => {
            const azureProcessor = new processor_1.ResponsesProcessor({
