...
describe('ReplicateProvider', () => {
    ...
    it('should handle successful API calls', async () => {
        ...
        const provider = new replicate_1.ReplicateProvider('test-model', {
            config: { apiKey: mockApiKey },
        });
        const result = await provider.callApi('test prompt');
        expect(result.output).toBe('test response');
        expect(mockedFetchWithCache).toHaveBeenCalledWith('https://api.replicate.com/v1/models/test-model/predictions', expect.objectContaining({
            method: 'POST',
    ...
    it('should use versioned endpoint for models with version IDs', async () => {
        ...
        const provider = new replicate_1.ReplicateProvider('test-model:version123', {
            config: { apiKey: mockApiKey },
        });
        await provider.callApi('test prompt');
        expect(mockedFetchWithCache).toHaveBeenCalledWith('https://api.replicate.com/v1/predictions', expect.objectContaining({
            method: 'POST',
...
describe('ReplicateModerationProvider', () => {
    ...
    it('should handle safe content correctly', async () => {
        ...
        const provider = new replicate_1.ReplicateModerationProvider('test-model', {
            config: { apiKey: mockApiKey },
        });
...
describe('DefaultModerationProvider', () => {
    it('should be configured with LlamaGuard 4', () => {
        expect(replicate_1.DefaultModerationProvider.modelName).toBe('meta/llama-guard-4-12b');
