...
const helicone_1 = require("../../src/providers/helicone");
describe('HeliconeGatewayProvider', () => {
    describe('constructor and configuration', () => {
        it('should create a provider with default configuration', () => {
            const provider = new helicone_1.HeliconeGatewayProvider('openai/gpt-4o');
            expect(provider).toBeInstanceOf(helicone_1.HeliconeGatewayProvider);
            expect(provider.modelName).toBe('openai/gpt-4o');
        });
        it('should use model from config when provided', () => {
            const provider = new helicone_1.HeliconeGatewayProvider('default-model', {
                config: {
...
//# sourceMappingURL=helicone.test.js.map