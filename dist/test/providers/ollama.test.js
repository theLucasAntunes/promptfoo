...
describe('OllamaCompletionProvider', () => {
    ...
    it('should construct with model name and options', () => {
        const provider = new ollama_1.OllamaCompletionProvider('llama3.3', {
            id: 'custom-id',
...
describe('OllamaChatProvider', () => {
    ...
    it('should construct with model name and options', () => {
        const provider = new ollama_1.OllamaChatProvider('llama3.3', {
            id: 'custom-id',
            config: { temperature: 0.7 },
        });
        expect(provider.modelName).toBe('llama3.3');
    ...
    it('should handle think configuration when it is not provided', async () => {
        ...
        expect(jest.mocked(cache_1.fetchWithCache).mock.calls[0]).toBeDefined();
        const call = jest.mocked(cache_1.fetchWithCache).mock.calls[0];
...
describe('OllamaEmbeddingProvider', () => {
    ...
    it('should call embeddings API and return response', async () => {
        ...
        jest.mocked(cache_1.fetchWithCache).mockResolvedValue(mockResponse);
        const provider = new ollama_1.OllamaEmbeddingProvider('llama3.3');
