...
const util_1 = require("../../../src/providers/openai/util");
jest.mock('../../../src/cache');
describe('failApiCall', () => {
    it('should format OpenAI API errors', () => {
        const error = new openai_1.default.APIError(400, {}, 'Bad request', new Headers());
        ...
        const result = (0, util_1.failApiCall)(error);
...
describe('getTokenUsage', () => {
    it('should return token usage for non-cached response', () => {
        ...
        const result = (0, util_1.getTokenUsage)(data, false);
        expect(result).toEqual({
            total: 100,
            prompt: 40,
            completion: 60,
    ...
    it('should return cached token usage', () => {
        ...
        const result = (0, util_1.getTokenUsage)(data, true);
        expect(result).toEqual({
            cached: 100,
            total: 100,
        });
...
describe('calculateOpenAICost', () => {
    it('should calculate cost correctly for transcription model gpt-4o-transcribe', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-transcribe', {}, 1000, 500);
    ...
    it('should calculate cost correctly for transcription model gpt-4o-mini-transcribe', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-mini-transcribe', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 1.25 + 500 * 5) / 1e6, 6);
    });
    it('should calculate cost correctly for TTS model gpt-4o-mini-tts', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-mini-tts', {}, 1000, 0, 0, 500);
    ...
    it('should calculate cost correctly for search preview model gpt-4o-search-preview', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-search-preview', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 2.5 + 500 * 10) / 1e6, 6);
    });
    it('should calculate cost correctly for search preview model gpt-4o-search-preview-2025-03-11', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-search-preview-2025-03-11', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 2.5 + 500 * 10) / 1e6, 6);
    });
    it('should calculate cost correctly for mini search preview model gpt-4o-mini-search-preview', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-mini-search-preview', {}, 1000, 500);
    ...
    it('should calculate audio token costs for gpt-4o-realtime-preview-2024-12-17', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-realtime-preview-2024-12-17', {}, 1000, 500, 200, 100);
    ...
    it('should calculate audio token costs for gpt-4o-mini-realtime-preview-2024-12-17', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-mini-realtime-preview-2024-12-17', {}, 1000, 500, 200, 100);
        const expectedCost = (1000 * 0.6 + 500 * 2.4 + 200 * 10 + 100 * 20) / 1e6;
        expect(cost).toBeCloseTo(expectedCost, 6);
    });
    it('should calculate audio token costs for gpt-realtime', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-realtime', {}, 1000, 500, 200, 100);
        const expectedCost = (1000 * 32 + 500 * 64 + 200 * 32 + 100 * 64) / 1e6;
        expect(cost).toBeCloseTo(expectedCost, 6);
    });
    it('should return undefined for zero tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.1', {}, 0, 0);
        expect(cost).toBeUndefined();
    });
    it('should handle only prompt tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.1', {}, 1000, 0);
        expect(cost).toBeCloseTo((1000 * 2) / 1e6, 6);
    });
    it('should handle only completion tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.1', {}, 0, 1000);
        expect(cost).toBeCloseTo((1000 * 8) / 1e6, 6);
    });
    it('should handle large token counts', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.1', {}, 1000000, 1000000);
        expect(cost).toBeCloseTo((1000000 * 2 + 1000000 * 8) / 1e6, 6);
    });
    it('should handle mixed undefined audio tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-audio-preview', {}, 1000, 500, undefined, 100);
        expect(cost).toBeUndefined();
    });
    it('should use custom audioCost from config when provided', () => {
        ...
        const model = util_1.OPENAI_CHAT_MODELS.find((m) => m.id === 'gpt-4o-audio-preview' &&
            m.cost &&
        ...
        const expectedTotalCost = (baseInputCost + baseOutputCost + audioInputCostCustom + audioOutputCostCustom) / 1;
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-audio-preview', { audioCost }, promiseTokens, completionTokens, audioPromptTokens, audioCompletionTokens);
    ...
    it('should calculate cost correctly for o3-deep-research', () => {
        const cost = (0, util_1.calculateOpenAICost)('o3-deep-research', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 10 + 500 * 40) / 1e6, 6);
    });
    it('should calculate cost correctly for o3-deep-research-2025-06-26', () => {
        const cost = (0, util_1.calculateOpenAICost)('o3-deep-research-2025-06-26', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 10 + 500 * 40) / 1e6, 6);
    });
    it('should calculate cost correctly for o4-mini-deep-research', () => {
        const cost = (0, util_1.calculateOpenAICost)('o4-mini-deep-research', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 2 + 500 * 8) / 1e6, 6);
    });
    it('should calculate cost correctly for o4-mini-deep-research-2025-06-26', () => {
        const cost = (0, util_1.calculateOpenAICost)('o4-mini-deep-research-2025-06-26', {}, 1000, 500);
        expect(cost).toBeCloseTo((1000 * 2 + 500 * 8) / 1e6, 6);
    });
});
describe('validateFunctionCall', () => {
    ...
    it('should validate valid function call', () => {
        ...
        expect(() => (0, util_1.validateFunctionCall)(functionCall, [sampleFunction], {})).not.toThrow();
    });
    it('should throw error for invalid function name', () => {
        ...
        expect(() => (0, util_1.validateFunctionCall)(functionCall, [sampleFunction], {})).toThrow('Called "nonexistentFunction", but there is no function with that name');
    });
    it('should throw error for invalid arguments', () => {
        ...
        expect(() => (0, util_1.validateFunctionCall)(functionCall, [sampleFunction], {})).toThrow(/Call to "testFunction" does not match schema/);
    });
});
describe('formatOpenAiError', () => {
    it('should format error with type and code', () => {
        ...
        const result = (0, util_1.formatOpenAiError)(error);
