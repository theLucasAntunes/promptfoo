...
describe('OpenAI Provider', () => {
    ...
    describe('OpenAiCompletionProvider', () => {
        ...
        it('should warn about unknown model', () => {
            ...
            new completion_1.OpenAiCompletionProvider('unknown-model');
            expect(warnSpy).toHaveBeenCalledWith('FYI: Using unknown OpenAI completion model: unknown-model');
            warnSpy.mockRestore();
        });
        ...
        it('should handle fetchWithCache returning undefined response', async () => {
            mockFetchWithCache.mockResolvedValue(undefined);
            const provider = new completion_1.OpenAiCompletionProvider('text-davinci-003');
            const result = await provider.callApi('Test prompt');
            expect(mockFetchWithCache).toHaveBeenCalledTimes(1);
