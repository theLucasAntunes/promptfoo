...
const responses_1 = require("../../../src/providers/openai/responses");
jest.mock('../../../src/cache', () => ({
...
describe('OpenAiResponsesProvider', () => {
    ...
    it('should support various model names', () => {
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-pro');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-pro');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4o');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1-2025-04-14');
        // GPT-5 models
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5-chat-latest');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5-nano');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5-mini');
        // GPT-4.5 models deprecated as of 2025-07-14, removed from API
    });
    it('should support the latest o-series reasoning models', () => {
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-2025-04-16');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o4-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o4-mini-2025-04-16');
    });
    it('should support gpt-4.1 and its variants', () => {
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1-2025-04-14');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1-mini-2025-04-14');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1-nano');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.1-nano-2025-04-14');
    });
    ...
    it('should format and call the responses API correctly', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('gpt-4o', {
            config: {
                apiKey: 'test-key',
            },
        });
        const result = await provider.callApi('Test prompt');
        expect(cache.fetchWithCache).toHaveBeenCalledWith(expect.stringContaining('/responses'), expect.objectContaining({
            method: 'POST',
            headers: expect.objectContaining({
                'Content-Type': 'application/json',
                Authorization: 'Bearer test-key',
            }),
        }), expect.any(Number), 'json', undefined, undefined);
    ...
    it('should handle system prompts correctly', async () => {
        ...
        expect(cache.fetchWithCache).toHaveBeenCalledWith(expect.any(String), expect.objectContaining({
    ...
    it('should handle reasoning models correctly', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('o1-pro', {
            config: {
                apiKey: 'test-key',
    ...
    it('should format JSON schema correctly in request body', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('gpt-4o', { config });
        await provider.callApi('Test prompt');
    ...
    it('should handle JSON stringify errors during logging', async () => {
        ...
        expect(cache.fetchWithCache).toHaveBeenCalledWith(expect.stringContaining('/responses'), expect.anything(), expect.anything(), 'json', undefined, undefined);
    ...
    describe('response format handling', () => {
        ...
        it('should handle external file loading for response_format correctly', () => {
            ...
            expect(() => {
                new responses_1.OpenAiResponsesProvider('gpt-4o', {
                    config: {
                        apiKey: 'test-key',
        ...
        it('should accept external file reference syntax for response_format', () => {
            ...
            expect(() => {
                new responses_1.OpenAiResponsesProvider('gpt-4o', {
                    config: {
                        apiKey: 'test-key',
                        response_format: 'file://relative/path/schema.json',
                    },
                });
            }).not.toThrow();
            expect(() => {
                new responses_1.OpenAiResponsesProvider('gpt-4o', {
                    config: {
                        apiKey: 'test-key',
                        response_format: 'file:///absolute/path/schema.json',
                    },
                });
            }).not.toThrow();
        });
    ...
    it('should configure o3 model correctly with reasoning parameters', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('o3', {
            config: {
                apiKey: 'test-key',
    ...
    it('should configure o3-pro model correctly with reasoning parameters', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('o3-pro', {
            config: {
                apiKey: 'test-key',
                reasoning_effort: 'high',
                max_output_tokens: 2000,
    ...
    it('should configure o4-mini model correctly with reasoning parameters', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('o4-mini', {
            config: {
                apiKey: 'test-key',
                reasoning_effort: 'medium',
    ...
    it('should configure codex-mini-latest model correctly with reasoning parameters', async () => {
        ...
        const provider = new responses_1.OpenAiResponsesProvider('codex-mini-latest', {
            config: {
                apiKey: 'test-key',
                reasoning_effort: 'medium',
                max_output_tokens: 1000,
    ...
    describe('MCP (Model Context Protocol) support', () => {
        it('should include MCP tools in request body correctly', async () => {
            ...
            const provider = new responses_1.OpenAiResponsesProvider('gpt-4.1', {
                config: {
                    apiKey: 'test-key',
                    tools: [
                        {
    ...
    describe('Enhanced OpenAI tools assertion with MCP support', () => {
        it('should validate MCP tool success correctly', async () => {
            ...
            const { handleIsValidOpenAiToolsCall } = await Promise.resolve().then(() => __importStar(require('../../../src/assertions/openai')));
        ...
        it('should validate MCP tool error correctly', async () => {
            ...
            expect(assertionResult.reason).toContain('MCP tool call failed for ask_question: Repository not found');
        });
    });
    it('should include all expected model names', () => {
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4o');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4o-2024-08-06');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4o-2024-11-20');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4o-2024-05-13');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-2024-12-17');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-preview');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-preview-2024-09-12');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-mini-2024-09-12');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-pro');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o1-pro-2025-03-19');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-pro');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-pro-2025-06-10');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-2025-04-16');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o4-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o4-mini-2025-04-16');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-mini-2025-01-31');
        // GPT-4.5 models deprecated as of 2025-07-14, removed from API
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('codex-mini-latest');
        // Deep research models
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-deep-research');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o3-deep-research-2025-06-26');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o4-mini-deep-research');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('o4-mini-deep-research-2025-06-26');
    });
    describe('deep research model validation', () => {
        ...
        it('should require web_search_preview tool for deep research models', async () => {
            const provider = new responses_1.OpenAiResponsesProvider('o3-deep-research', {
                config: {
                    apiKey: 'test-key',
        ...
        it('should accept deep research models with web_search_preview tool', async () => {
            ...
            cache.fetchWithCache.mockResolvedValueOnce({
                data: mockData,
                status: 200,
                statusText: 'OK',
                cached: false,
            });
            const provider = new responses_1.OpenAiResponsesProvider('o4-mini-deep-research', {
                config: {
                    apiKey: 'test-key',
        ...
        it('should use longer timeout for deep research models', async () => {
            ...
            expect(cache.fetchWithCache).toHaveBeenCalledWith(expect.any(String), expect.any(Object), 600000, // 10 minutes
        ...
        it('should handle tool callback integration test with expected result format', async () => {
            ...
            const provider = new responses_1.OpenAiResponsesProvider('gpt-4o', {
                config: {
                    ...
                    tool_choice: 'auto',
                    functionToolCallbacks: {
                        addNumbers: async (parametersJsonString) => {
