...
const util_1 = require("../../../src/providers/bedrock/util");
describe('novaOutputFromMessage', () => {
    it('should handle tool use blocks', () => {
        ...
        const result = (0, util_1.novaOutputFromMessage)(response);
        expect(result).toBe('{"name":"tool1","toolUseId":"123","input":{"foo":"bar"}}\n\n{"name":"tool2","toolUseId":"456","input":{"baz":"qux"}}');
    });
...
describe('novaParseMessages', () => {
    it('should parse JSON messages', () => {
        ...
        const result = (0, util_1.novaParseMessages)(messages);
