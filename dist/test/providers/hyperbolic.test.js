...
const audio_1 = require("../../src/providers/hyperbolic/audio");
const chat_1 = require("../../src/providers/hyperbolic/chat");
...
describe('HyperbolicProvider', () => {
    ...
    describe('constructor', () => {
        it('should create a provider with default config', () => {
            provider = new chat_1.HyperbolicProvider('deepseek-ai/DeepSeek-R1', {});
    ...
    describe('isReasoningModel', () => {
        it('should identify reasoning models correctly', () => {
            const reasoningProvider = new chat_1.HyperbolicProvider('deepseek-ai/DeepSeek-R1', {});
            expect(reasoningProvider['isReasoningModel']()).toBe(true);
            const qwqProvider = new chat_1.HyperbolicProvider('qwen/QwQ-32B', {});
            expect(qwqProvider['isReasoningModel']()).toBe(true);
            const regularProvider = new chat_1.HyperbolicProvider('meta-llama/Llama-3.1-70B', {});
    ...
    describe('callApi', () => {
        it('should handle successful API response', async () => {
            ...
            jest.spyOn(chat_2.OpenAiChatCompletionProvider.prototype, 'callApi').mockResolvedValue(mockResponse);
        ...
        it('should handle API errors', async () => {
            ...
            jest.spyOn(chat_2.OpenAiChatCompletionProvider.prototype, 'callApi').mockResolvedValue(mockError);
            const result = await provider.callApi('Test prompt');
    ...
    describe('calculateHyperbolicCost', () => {
        it('should calculate cost for known models', () => {
            const cost = (0, chat_1.calculateHyperbolicCost)('deepseek-ai/DeepSeek-R1', {}, 1000, 500);
            expect(cost).toBe((0.5 / 1e6) * 1000 + (2.18 / 1e6) * 500);
        });
        it('should handle model aliases', () => {
            const cost = (0, chat_1.calculateHyperbolicCost)('DeepSeek-R1', {}, 1000, 500);
            expect(cost).toBe((0.5 / 1e6) * 1000 + (2.18 / 1e6) * 500);
        });
        it('should return undefined for unknown models', () => {
            const cost = (0, chat_1.calculateHyperbolicCost)('unknown-model', {}, 1000, 500);
            expect(cost).toBeUndefined();
        });
        it('should return undefined if tokens are missing', () => {
            const cost = (0, chat_1.calculateHyperbolicCost)('deepseek-ai/DeepSeek-R1', {}, undefined, 500);
            expect(cost).toBeUndefined();
        });
        it('should use custom cost from config', () => {
            const customCost = 0.001;
            const cost = (0, chat_1.calculateHyperbolicCost)('deepseek-ai/DeepSeek-R1', { cost: customCost }, 1000, 500);
...
describe('HyperbolicImageProvider', () => {
    ...
    describe('constructor', () => {
        it('should create an image provider with default model', () => {
            provider = new image_1.HyperbolicImageProvider('Flux.1-dev', {});
    ...
    describe('getApiModelName', () => {
        it('should resolve model aliases', () => {
            provider = new image_1.HyperbolicImageProvider('flux-dev', {});
            expect(provider['getApiModelName']()).toBe('Flux.1-dev');
            provider = new image_1.HyperbolicImageProvider('sdxl', {});
            expect(provider['getApiModelName']()).toBe('SDXL1.0-base');
        });
        it('should return original name for unknown models', () => {
            provider = new image_1.HyperbolicImageProvider('custom-model', {});
    ...
    describe('calculateImageCost', () => {
        it('should return correct cost for known models', () => {
            ...
            provider = new image_1.HyperbolicImageProvider('SDXL1.0-base', {});
            expect(provider['calculateImageCost']()).toBe(0.01);
        });
        it('should return default cost for unknown models', () => {
            provider = new image_1.HyperbolicImageProvider('unknown-model', {});
            expect(provider['calculateImageCost']()).toBe(0.01);
        });
    });
});
describe('HyperbolicAudioProvider', () => {
    ...
    describe('constructor', () => {
        it('should create an audio provider with default model', () => {
            provider = new audio_1.HyperbolicAudioProvider('Melo-TTS', {});
        ...
        it('should use default model if none specified', () => {
            provider = new audio_1.HyperbolicAudioProvider('', {});
...
//# sourceMappingURL=hyperbolic.test.js.map