import type { TestCase, TestCaseWithVarsFile, TestSuiteConfig } from '../types/index';
...
export declare function readTest(test: string | TestCaseWithVarsFile, basePath?: string, isDefaultTest?: boolean): Promise<TestCase>;
/**
