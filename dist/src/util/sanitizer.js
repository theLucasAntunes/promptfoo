...
exports.sanitizeQueryParams = exports.sanitizeHeaders = exports.sanitizeBody = void 0;
...
function isClassInstance(obj) {
    ...
    const hasMethods = Object.getOwnPropertyNames(proto).some((prop) => prop !== 'constructor' && typeof proto[prop] === 'function');
    return hasMethods;
}
/**
...
function sanitizeObject(obj, options = {}) {
    ...
    try {
        ...
        const safeObj = JSON.parse((0, fast_safe_stringify_1.default)(obj, undefined, undefined, {
...
exports.sanitizeBody = sanitizeObject;
exports.sanitizeHeaders = sanitizeObject;
exports.sanitizeQueryParams = sanitizeObject;
