...
exports.promptfooCommand = promptfooCommand;
...
function detectInstaller() {
    ...
    if ((npmExecPath && npmExecPath.includes('npx')) ||
    ...
    if (/Homebrew[\/\\]Cellar/i.test(prefix) ||
...
//# sourceMappingURL=promptfooCommand.js.map