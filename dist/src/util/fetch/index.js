...
const monkeyPatchFetch_1 = require("./monkeyPatchFetch");
async function fetchWithProxy(url, options = {}) {
    ...
    if (proxyUrl) {
        logger_1.default.debug(`Using proxy: ${(0, sanitizer_1.sanitizeUrl)(proxyUrl)}`);
    ...
    return await (0, monkeyPatchFetch_1.monkeyPatchFetch)(finalUrl, finalOptions);
}
