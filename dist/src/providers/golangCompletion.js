    ...
    async executeGolangScript(prompt, context, apiType) {
        ...
        if (cachedResult) {
            ...
            try {
                ...
                await execFileAsync(goExecutable, ['build', '-o', executablePath, 'wrapper.go', path_1.default.basename(relativeScriptPath)], { cwd: scriptDir });
                const jsonArgs = (0, json_1.safeJsonStringify)(args) || '[]';
                logger_1.default.debug(`Running Go executable: ${executablePath}`);
