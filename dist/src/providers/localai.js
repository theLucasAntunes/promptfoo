    ...
    constructor(modelName, options = {}) {
        ...
        this.apiBaseUrl =
            config?.apiBaseUrl ||
                ...
                (0, envars_1.getEnvString)('LOCALAI_BASE_URL') ||
...
class LocalAiChatProvider extends LocalAiGenericProvider {
    async callApi(prompt) {
        ...
        const body = {
            ...
            messages,
            temperature: this.config.temperature || (0, envars_1.getEnvFloat)('LOCALAI_TEMPERATURE') || 0.7,
        };
        let data;
        try {
            ({ data } = (await (0, cache_1.fetchWithCache)(`${this.apiBaseUrl}/chat/completions`, {
                method: 'POST',
                headers: {
...
class LocalAiEmbeddingProvider extends LocalAiGenericProvider {
    async callEmbeddingApi(text) {
        ...
        let data;
        try {
            ({ data } = (await (0, cache_1.fetchWithCache)(`${this.apiBaseUrl}/embeddings`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
class LocalAiCompletionProvider extends LocalAiGenericProvider {
    async callApi(prompt) {
        ...
        let data;
        try {
            ({ data } = (await (0, cache_1.fetchWithCache)(`${this.apiBaseUrl}/completions`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
