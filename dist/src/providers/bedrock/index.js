...
const getLlamaModelHandler = (version) => {
    ...
    return {
        params: (config, prompt, _stop, _modelName) => {
...
exports.BEDROCK_MODEL = {
    ...
    AMAZON_NOVA: {
        params: (config, prompt, _stop, _modelName) => {
            ...
            try {
                ...
                if (Array.isArray(parsed)) {
                    ...
                    const { system, extractedMessages } = (0, util_2.novaParseMessages)(prompt);
        ...
        output: (_config, responseJson) => (0, util_2.novaOutputFromMessage)(responseJson),
        tokenUsage: (responseJson, _promptText) => {
    ...
    CLAUDE_COMPLETION: {
        params: (config, prompt, stop, _modelName) => {
            const params = {
    ...
    CLAUDE_MESSAGES: {
        params: (config, prompt, _stop, _modelName) => {
            ...
            try {
                ...
                if (Array.isArray(parsed)) {
                    ...
                    const { system, extractedMessages } = (0, util_1.parseMessages)(prompt);
                    messages = extractedMessages;
                    systemPrompt = system;
                }
            }
            ...
            addConfigParam(params, 'anthropic_version', config?.anthropic_version, undefined, 'bedrock-2023-05-31');
            addConfigParam(params, 'tools', (0, index_1.maybeLoadToolsFromExternalFile)(config?.tools), undefined, undefined);
        ...
        output: (config, responseJson) => {
            return (0, util_1.outputFromMessage)(responseJson, config?.showThinking ?? true);
        },
        tokenUsage: (responseJson, _promptText) => {
            if (!responseJson?.usage) {
                return {
    ...
    COHERE_COMMAND_R: {
        params: (config, prompt, stop, _modelName) => {
            ...
            addConfigParam(params, 'tools', (0, index_1.maybeLoadToolsFromExternalFile)(config?.tools));
...
<think>\n`;
    ...
    OPENAI: {
        params: (config, prompt, stop, _modelName) => {
            ...
            addConfigParam(params, 'max_completion_tokens', config?.max_completion_tokens, (0, envars_1.getEnvInt)('AWS_BEDROCK_MAX_TOKENS'), undefined);
            addConfigParam(params, 'temperature', config?.temperature, (0, envars_1.getEnvFloat)('AWS_BEDROCK_TEMPERATURE'), 0.1);
            addConfigParam(params, 'top_p', config?.top_p, (0, envars_1.getEnvFloat)('AWS_BEDROCK_TOP_P'), 1.0);
            if ((stop && stop.length > 0) || config?.stop) {
                addConfigParam(params, 'stop', stop || config?.stop, (0, envars_1.getEnvString)('AWS_BEDROCK_STOP'));
            }
            addConfigParam(params, 'frequency_penalty', config?.frequency_penalty, (0, envars_1.getEnvFloat)('AWS_BEDROCK_FREQUENCY_PENALTY'));
            addConfigParam(params, 'presence_penalty', config?.presence_penalty, (0, envars_1.getEnvFloat)('AWS_BEDROCK_PRESENCE_PENALTY'));
            return params;
    ...
    QWEN: {
        params: (config, prompt, stop, _modelName) => {
            ...
            addConfigParam(params, 'max_tokens', config?.max_tokens, (0, envars_1.getEnvInt)('AWS_BEDROCK_MAX_TOKENS'), undefined);
            addConfigParam(params, 'temperature', config?.temperature, (0, envars_1.getEnvFloat)('AWS_BEDROCK_TEMPERATURE'), 0.7);
            addConfigParam(params, 'top_p', config?.top_p, (0, envars_1.getEnvFloat)('AWS_BEDROCK_TOP_P'), 1.0);
            if ((stop && stop.length > 0) || config?.stop) {
                addConfigParam(params, 'stop', stop || config?.stop, (0, envars_1.getEnvString)('AWS_BEDROCK_STOP'));
            }
...
exports.AWS_BEDROCK_MODELS = {
    ...
    'anthropic.claude-opus-4-1-20250805-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'anthropic.claude-sonnet-4-5-20250929-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'anthropic.claude-haiku-4-5-20251001-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'apac.anthropic.claude-opus-4-1-20250805-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'apac.anthropic.claude-sonnet-4-5-20250929-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'apac.anthropic.claude-haiku-4-5-20251001-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'eu.anthropic.claude-opus-4-1-20250805-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'eu.anthropic.claude-sonnet-4-5-20250929-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'eu.anthropic.claude-haiku-4-5-20251001-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'us.anthropic.claude-opus-4-1-20250805-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'us.anthropic.claude-sonnet-4-5-20250929-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'us.anthropic.claude-haiku-4-5-20251001-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'openai.gpt-oss-120b-1:0': exports.BEDROCK_MODEL.OPENAI,
    'openai.gpt-oss-20b-1:0': exports.BEDROCK_MODEL.OPENAI,
    // Qwen Models via Bedrock
    'qwen.qwen3-coder-480b-a35b-v1:0': exports.BEDROCK_MODEL.QWEN,
    'qwen.qwen3-coder-30b-a3b-v1:0': exports.BEDROCK_MODEL.QWEN,
    'qwen.qwen3-235b-a22b-2507-v1:0': exports.BEDROCK_MODEL.QWEN,
    'qwen.qwen3-32b-v1:0': exports.BEDROCK_MODEL.QWEN,
};
...
function getHandlerForModel(modelName, config) {
    ...
    if (modelName.includes('arn:') && modelName.includes('inference-profile')) {
        ...
        if (!inferenceModelType) {
            throw new Error('Inference profile requires inferenceModelType to be specified in config. ' +
        ...
        switch (inferenceModelType) {
            ...
            case 'titan':
                return exports.BEDROCK_MODEL.TITAN_TEXT;
            case 'deepseek':
                return exports.BEDROCK_MODEL.DEEPSEEK;
            case 'openai':
                return exports.BEDROCK_MODEL.OPENAI;
            case 'qwen':
                return exports.BEDROCK_MODEL.QWEN;
            default:
...
class AwsBedrockCompletionProvider extends AwsBedrockGenericProvider {
    async callApi(prompt, context) {
        ...
        logger_1.default.debug('Calling Amazon Bedrock API', { params });
        ...
        try {
            ...
            logger_1.default.error('Bedrock API response error', { error: String(err), response });
            return {
...
class AwsBedrockEmbeddingProvider extends AwsBedrockGenericProvider {
    ...
    async callEmbeddingApi(text) {
        ...
        logger_1.default.debug('Calling AWS Bedrock API for embeddings', { params });
        let response;
        try {
            const bedrockInstance = await this.getBedrockInstance();
            response = await bedrockInstance.invokeModel({
