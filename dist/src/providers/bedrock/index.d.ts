...
export declare const getLlamaModelHandler: (version: LlamaVersion) => {
    params: (config: BedrockLlamaGenerationOptions, prompt: string, _stop?: string[], _modelName?: string) => {
        prompt: string;
        temperature?: number;
        top_p?: number;
        max_gen_len?: number;
    };
    output: (_config: BedrockOptions, responseJson: any) => any;
    tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
};
export declare const BEDROCK_MODEL: {
    AI21: {
        params: (config: BedrockAI21GenerationOptions, prompt: string, _stop?: string[], _modelName?: string) => any;
        output: (_config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    AMAZON_NOVA: {
        params: (config: BedrockAmazonNovaGenerationOptions, prompt: string, _stop?: string[], _modelName?: string) => any;
        output: (_config: BedrockOptions, responseJson: any) => string | undefined;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    CLAUDE_COMPLETION: {
        params: (config: BedrockClaudeLegacyCompletionOptions, prompt: string, stop: string[], _modelName?: string) => any;
        output: (_config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    CLAUDE_MESSAGES: {
        params: (config: BedrockClaudeMessagesCompletionOptions, prompt: string, _stop?: string[], _modelName?: string) => any;
        output: (config: BedrockClaudeMessagesCompletionOptions, responseJson: any) => string;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    TITAN_TEXT: {
        params: (config: BedrockTextGenerationOptions, prompt: string, stop?: string[], _modelName?: string) => {
            inputText: string;
    ...
    COHERE_COMMAND: {
        params: (config: BedrockCohereCommandGenerationOptions, prompt: string, stop?: string[], _modelName?: string) => any;
        output: (_config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    COHERE_COMMAND_R: {
        params: (config: BedrockCohereCommandRGenerationOptions, prompt: string, stop?: string[], _modelName?: string) => CohereCommandRRequestParams;
        output: (_config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    DEEPSEEK: {
        params: (config: BedrockDeepseekGenerationOptions, prompt: string, _stop?: string[], _modelName?: string) => any;
        output: (config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    MISTRAL: {
        params: (config: BedrockMistralGenerationOptions, prompt: string, stop: string[], _modelName?: string) => any;
        output: (_config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    MISTRAL_LARGE_2407: {
    ...
    OPENAI: {
        params: (config: BedrockOpenAIGenerationOptions, prompt: string, stop?: string[], _modelName?: string) => any;
        output: (_config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
    QWEN: {
        params: (config: BedrockQwenGenerationOptions, prompt: string, stop?: string[], _modelName?: string) => any;
        output: (config: BedrockOptions, responseJson: any) => any;
        tokenUsage: (responseJson: any, _promptText: string) => TokenUsage;
    };
};
