...
class HuggingfaceTextGenerationProvider {
    ...
    getApiKey() {
        return this.config.apiKey || (0, envars_1.getEnvString)('HF_TOKEN') || (0, envars_1.getEnvString)('HF_API_TOKEN');
    }
    getConfig() {
    ...
    async callApi(prompt) {
        ...
        logger_1.default.debug(`Huggingface API request: ${url}`, { params });
        let response;
        try {
            ...
            logger_1.default.debug('Huggingface API response', { data: response.data });
