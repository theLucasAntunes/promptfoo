...
exports.createEnvoyProvider = createEnvoyProvider;
...
function createEnvoyProvider(providerPath, options = {}) {
    ...
    if (!apiBaseUrl) {
        throw new Error('Envoy provider requires a gateway URL. Set ENVOY_API_BASE_URL environment variable or specify apiBaseUrl in config.');
    }
    ...
    return new chat_1.OpenAiChatCompletionProvider(modelName, envoyConfig);
}
