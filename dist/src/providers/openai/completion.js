...
OpenAiCompletionProvider.OPENAI_COMPLETION_MODELS = util_1.OPENAI_COMPLETION_MODELS;
OpenAiCompletionProvider.OPENAI_COMPLETION_MODEL_NAMES = util_1.OPENAI_COMPLETION_MODELS.map((model) => model.id);
