...
exports.OPENAI_REALTIME_MODELS = exports.OPENAI_COMPLETION_MODELS = exports.OPENAI_DEEP_RESEARCH_MODELS = exports.OPENAI_CHAT_MODELS = void 0;
...
exports.OPENAI_DEEP_RESEARCH_MODELS = [
...
function validateFunctionCall(output, functions, vars) {
    ...
    const interpolatedFunctions = (0, file_1.maybeLoadFromExternalFile)((0, index_1.renderVarsInObject)(functions, vars));
