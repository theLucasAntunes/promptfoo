...
OpenAiModerationProvider.MODERATION_MODELS = OPENAI_MODERATION_MODELS;
OpenAiModerationProvider.MODERATION_MODEL_IDS = OPENAI_MODERATION_MODELS.map((model) => model.id);
