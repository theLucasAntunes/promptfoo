...
exports.calculatePerplexityCost = calculatePerplexityCost;
exports.createPerplexityProvider = createPerplexityProvider;
 ...
 */
class PerplexityProvider extends chat_1.OpenAiChatCompletionProvider {
...
function createPerplexityProvider(providerPath, options = {}) {
    ...
    return new PerplexityProvider(modelName, options);
}
