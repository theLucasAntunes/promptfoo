...
exports.AzureModerationProvider = void 0;
...
function getModerationCacheKey(modelName, _config, content) {
...
AzureModerationProvider.MODERATION_MODELS = AZURE_MODERATION_MODELS;
AzureModerationProvider.MODERATION_MODEL_IDS = AZURE_MODERATION_MODELS.map((model) => model.id);
