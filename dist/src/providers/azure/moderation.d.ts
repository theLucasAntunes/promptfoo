...
export declare function getModerationCacheKey(modelName: string, _config: any, content: string): string;
export declare class AzureModerationProvider extends AzureGenericProvider implements ApiModerationProvider {
    ...
    callModerationApi(_userPrompt: string, assistantResponse: string): Promise<ProviderModerationResponse>;
}
export {};
