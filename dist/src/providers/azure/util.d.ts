 ...
 */
export declare function calculateAzureCost(modelName: string, _config: AzureCompletionOptions, promptTokens?: number, completionTokens?: number): number | undefined;
