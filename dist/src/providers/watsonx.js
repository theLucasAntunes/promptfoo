...
class WatsonXProvider {
    ...
    async getAuth() {
        ...
        try {
            ({ IamAuthenticator, BearerTokenAuthenticator } = await Promise.resolve().then(() => __importStar(require('ibm-cloud-sdk-core'))));
        }
        catch (err) {
            logger_1.default.error(`Error loading ibm-cloud-sdk-core: ${err}`);
    ...
    async getClient() {
        ...
        try {
            ...
            logger_1.default.error(`Error loading @ibm-cloud/watsonx-ai: ${err}`);
