...
exports.GROK_4_MODELS = exports.GROK_REASONING_MODELS = exports.GROK_REASONING_EFFORT_MODELS = exports.GROK_3_MINI_MODELS = exports.XAI_CHAT_MODELS = void 0;
...
exports.GROK_REASONING_EFFORT_MODELS = [
    'grok-3-mini-beta',
    'grok-3-mini',
    'grok-3-mini-latest',
    'grok-3-mini-fast-beta',
...
exports.GROK_4_MODELS = ['grok-4-0709', 'grok-4', 'grok-4-latest'];
/**
...
class XAIProvider extends chat_1.OpenAiChatCompletionProvider {
    ...
    isReasoningModel() {
        return exports.GROK_REASONING_MODELS.includes(this.modelName);
    }
    supportsReasoningEffort() {
        return exports.GROK_REASONING_EFFORT_MODELS.includes(this.modelName);
    }
    supportsTemperature() {
        return true;
    }
    getOpenAiBody(prompt, context, callApiOptions) {
        ...
        if (this.modelName && exports.GROK_4_MODELS.includes(this.modelName)) {
