import type { ApiProvider, ApiSimilarityProvider, ProviderClassificationResponse, ProviderEmbeddingResponse, ProviderResponse, ProviderSimilarityResponse } from '../types/index';
...
export declare class HuggingfaceTextGenerationProvider implements ApiProvider {
    ...
    getConfig(): Partial<Record<"temperature" | "top_p" | "top_k" | "max_new_tokens" | keyof HuggingfaceProviderOptions | "repetition_penalty" | "max_time" | "return_full_text" | "num_return_sequences" | "do_sample" | "use_cache" | "wait_for_model", string | number | boolean | undefined>>;
