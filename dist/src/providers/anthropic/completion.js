...
class AnthropicCompletionProvider extends generic_1.AnthropicGenericProvider {
    ...
    async callApi(prompt) {
        ...
        logger_1.default.debug('Calling Anthropic API', { params });
        ...
        logger_1.default.debug('\tAnthropic API response', { response });
        if ((0, cache_1.isCacheEnabled)()) {
            try {
        ...
        try {
            return {
                ...
                tokenUsage: (0, tokenUsageUtils_1.createEmptyTokenUsage)(), // TODO: add token usage once Anthropic API supports it
            };
        }
        catch (err) {
            return {
