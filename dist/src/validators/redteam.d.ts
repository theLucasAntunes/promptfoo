 ...
 */
export declare const RedteamPluginSchema: z.ZodUnion<[z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>]>, z.ZodObject<{
    id: z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>]>;
    numTests: z.ZodDefault<z.ZodNumber>;
    config: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    severity: z.ZodOptional<z.ZodNativeEnum<typeof Severity>>;
...
export declare const strategyIdSchema: z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>;
/**
 * Schema for individual redteam strategies
 */
export declare const RedteamStrategySchema: z.ZodUnion<[z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>, z.ZodObject<{
    id: z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>;
    config: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
}, "strip", z.ZodTypeAny, {
    id: string;
    config?: Record<string, unknown> | undefined;
...
export declare const RedteamGenerateOptionsSchema: z.ZodObject<{
    ...
    strategies: z.ZodOptional<z.ZodArray<z.ZodUnion<[z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>, z.ZodObject<{
        id: z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>;
        config: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    }, "strip", z.ZodTypeAny, {
        id: string;
    ...
    configFromCloud: z.ZodOptional<z.ZodAny>;
}, "strip", z.ZodTypeAny, {
    cache: boolean;
...
export declare const RedteamConfigSchema: z.ZodEffects<z.ZodObject<{
    ...
    strategies: z.ZodDefault<z.ZodOptional<z.ZodArray<z.ZodUnion<[z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>, z.ZodObject<{
        id: z.ZodUnion<[z.ZodEffects<z.ZodEnum<[string, ...string[]]>, string, string>, z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>;
        config: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    }, "strip", z.ZodTypeAny, {
        id: string;
