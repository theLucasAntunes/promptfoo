...
exports.handleIsHtml = exports.handleContainsHtml = void 0;
...
function validateHtml(htmlString) {
    ...
    try {
        // Parse with jsdom
        const dom = new jsdom_1.JSDOM(trimmed, {
        ...
        if (isWrapped) {
            ...
            const hasText = Array.from(document.body.childNodes).some((node) => node.nodeType === 3 /* TEXT_NODE */ && node.textContent?.trim());
            if (hasText) {
...
exports.handleContainsHtml = handleContainsHtml;
...
exports.handleIsHtml = handleIsHtml;
