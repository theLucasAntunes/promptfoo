...
exports.calculateGleuScore = calculateGleuScore;
exports.handleGleuScore = handleGleuScore;
...
function handleGleuScore({ assertion, inverse, outputString, renderedValue, }) {
    ...
    (0, invariant_1.default)(typeof renderedValue === 'string' ||
        (Array.isArray(renderedValue) && renderedValue.every((v) => typeof v === 'string')), '"gleu" assertion must have a string or array of strings value');
