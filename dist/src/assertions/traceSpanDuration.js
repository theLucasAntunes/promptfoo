...
exports.handleTraceSpanDuration = void 0;
...
const handleTraceSpanDuration = ({ assertion, context }) => {
    ...
    const matchingSpans = spans.filter((span) => {
        return (matchesPattern(span.name, pattern) &&
...
exports.handleTraceSpanDuration = handleTraceSpanDuration;
//# sourceMappingURL=traceSpanDuration.js.map