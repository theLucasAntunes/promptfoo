...
exports.AssertionsResult = exports.DEFAULT_TOKENS_USED = exports.GUARDRAIL_BLOCKED_REASON = void 0;
const envars_1 = require("../envars");
const index_1 = require("../types/index");
exports.GUARDRAIL_BLOCKED_REASON = 'Content failed guardrail safety checks';
...
class AssertionsResult {
    ...
    async testResult(scoringFunction) {
        ...
        if (this.failedContentSafetyChecks) {
            pass = true;
            reason = exports.GUARDRAIL_BLOCKED_REASON;
        }
        ...
        if (scoringFunction) {
            try {
                ...
                if (!(0, index_1.isGradingResult)(scoringResult)) {
