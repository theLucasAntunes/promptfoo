...
exports.handleTraceErrorSpans = void 0;
...
function isErrorSpan(span) {
    ...
    if (span.attributes) {
        ...
        if (span.attributes['otel.status_code'] === 'ERROR' ||
...
const handleTraceErrorSpans = ({ assertion, context }) => {
...
exports.handleTraceErrorSpans = handleTraceErrorSpans;
//# sourceMappingURL=traceErrorSpans.js.map