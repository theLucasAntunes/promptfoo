import type { ApiProvider, Assertion, GradingConfig, GradingResult, ProviderType, TokenUsage } from './types/index';
...
export declare function fail(reason: string, tokensUsed?: Partial<TokenUsage>): Omit<GradingResult, 'assertion'>;
...
export declare function matchesLlmRubric(rubric: string | object, llmOutput: string, grading?: GradingConfig, vars?: Record<string, string | object>, assertion?: Assertion, options?: {
    throwOnError?: boolean;
}): Promise<GradingResult>;
export declare function matchesPiScore(renderedValue: string, llmInput: string, llmOutput: string, assertion?: Assertion): Promise<GradingResult>;
...
export declare function matchesContextRecall(context: string | string[], groundTruth: string, threshold: number, grading?: GradingConfig, vars?: Record<string, string | object>): Promise<Omit<GradingResult, 'assertion'>>;
export declare function matchesContextRelevance(question: string, context: string | string[], threshold: number, grading?: GradingConfig): Promise<Omit<GradingResult, 'assertion'>>;
export declare function matchesContextFaithfulness(query: string, output: string, context: string | string[], threshold: number, grading?: GradingConfig, vars?: Record<string, string | object>): Promise<Omit<GradingResult, 'assertion'>>;
...
export declare function selectMaxScore(outputs: string[], resultsWithGradingResults: Array<{
    gradingResult?: {
        componentResults?: GradingResult[];
    } | null;
}>, assertion: Assertion): Promise<Omit<GradingResult, 'assertion'>[]>;
