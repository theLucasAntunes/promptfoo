...
exports.homoglyphMap = void 0;
exports.toHomoglyphs = toHomoglyphs;
exports.addHomoglyphs = addHomoglyphs;
// Map of standard characters to homoglyph unicode characters
exports.homoglyphMap = {
...
function toHomoglyphs(text) {
    return text
        .split('')
        .map((char) => exports.homoglyphMap[char] || char)
        .join('');
}
/**
