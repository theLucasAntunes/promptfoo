...
async function redteamInit(directory) {
    ...
    telemetry_1.default.record('redteam init', { phase: 'started' });
  ...
  `);
    ...
    telemetry_1.default.record('redteam init', { phase: 'completed' });
    ...
    if (deferGeneration) {
        logger_1.default.info('\n' +
          ...
          To generate test cases and run your red team, use the command:
              ...
              ${chalk_1.default.bold((0, promptfooCommand_1.promptfooCommand)('redteam run'))}
        `));
        return;
    }
    else {
    ...
    program
        ...
        try {
            ...
            if (useGui) {
                ...
                if (isRunning) {
                    await (0, server_2.openBrowser)(server_2.BrowserBehavior.OPEN_TO_REDTEAM_CREATE);
                }
                else {
            ...
            if (err instanceof core_1.ExitPromptError) {
                logger_1.default.info('\n' +
                    ...
                    chalk_1.default.bold((0, promptfooCommand_1.promptfooCommand)('redteam init')));
