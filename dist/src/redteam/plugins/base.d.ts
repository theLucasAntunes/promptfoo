import type { ApiProvider, Assertion, AssertionValue, AtomicTestCase, GradingResult, PluginConfig, ResultSuggestion, TestCase } from '../../types/index';
/**
...
export declare abstract class RedteamGraderBase {
    ...
    getResult(prompt: string, llmOutput: string, test: AtomicTestCase, provider: ApiProvider | undefined, renderedValue: AssertionValue | undefined, additionalRubric?: string, skipRefusalCheck?: boolean): Promise<{
        grade: GradingResult;
        rubric: string;
