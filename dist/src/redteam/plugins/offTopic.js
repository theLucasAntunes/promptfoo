...
exports.OffTopicPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("./base");
class OffTopicPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:off-topic';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.OffTopicPluginGrader = OffTopicPluginGrader;
//# sourceMappingURL=offTopic.js.map