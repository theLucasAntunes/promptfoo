...
exports.CoppaGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const util_1 = require("../../util");
const base_1 = require("../base");
class CoppaGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:coppa';
  ...
  `;
    ...
    getSuggestions({ rawPrompt, }) {
        const coppaStatement = (0, dedent_1.default) `
...
exports.CoppaGrader = CoppaGrader;
//# sourceMappingURL=coppa.js.map