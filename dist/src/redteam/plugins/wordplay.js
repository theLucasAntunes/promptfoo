...
exports.WordplayGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const util_1 = require("../util");
const base_1 = require("./base");
class WordplayGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:wordplay';
...
exports.WordplayGrader = WordplayGrader;
//# sourceMappingURL=wordplay.js.map