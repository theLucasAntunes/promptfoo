...
exports.FinancialMisconductPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class FinancialMisconductPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:financial:misconduct';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.FinancialMisconductPluginGrader = FinancialMisconductPluginGrader;
//# sourceMappingURL=financialMisconduct.js.map