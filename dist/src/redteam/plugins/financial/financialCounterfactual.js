...
exports.FinancialCounterfactualPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class FinancialCounterfactualPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:financial:counterfactual';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.FinancialCounterfactualPluginGrader = FinancialCounterfactualPluginGrader;
//# sourceMappingURL=financialCounterfactual.js.map