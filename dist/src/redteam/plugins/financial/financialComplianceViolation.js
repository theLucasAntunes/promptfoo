...
exports.FinancialComplianceViolationPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class FinancialComplianceViolationPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:financial:compliance-violation';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.FinancialComplianceViolationPluginGrader = FinancialComplianceViolationPluginGrader;
//# sourceMappingURL=financialComplianceViolation.js.map