...
exports.FinancialHallucinationPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class FinancialHallucinationPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:financial:hallucination';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.FinancialHallucinationPluginGrader = FinancialHallucinationPluginGrader;
//# sourceMappingURL=financialHallucination.js.map