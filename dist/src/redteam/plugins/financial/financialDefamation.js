...
exports.FinancialDefamationPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class FinancialDefamationPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:financial:defamation';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.FinancialDefamationPluginGrader = FinancialDefamationPluginGrader;
//# sourceMappingURL=financialDefamation.js.map