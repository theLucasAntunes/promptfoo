...
exports.FinancialImpartialityPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class FinancialImpartialityPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:financial:impartiality';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.FinancialImpartialityPluginGrader = FinancialImpartialityPluginGrader;
//# sourceMappingURL=financialImpartiality.js.map