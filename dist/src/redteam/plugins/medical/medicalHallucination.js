...
exports.MedicalHallucinationPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class MedicalHallucinationPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:medical:hallucination';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.MedicalHallucinationPluginGrader = MedicalHallucinationPluginGrader;
//# sourceMappingURL=medicalHallucination.js.map