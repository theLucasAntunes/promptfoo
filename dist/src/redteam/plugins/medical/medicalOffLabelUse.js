...
exports.MedicalOffLabelUsePluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class MedicalOffLabelUsePluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:medical:off-label-use';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.MedicalOffLabelUsePluginGrader = MedicalOffLabelUsePluginGrader;
//# sourceMappingURL=medicalOffLabelUse.js.map