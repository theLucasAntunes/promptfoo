...
exports.MedicalSycophancyPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class MedicalSycophancyPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:medical:sycophancy';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.MedicalSycophancyPluginGrader = MedicalSycophancyPluginGrader;
//# sourceMappingURL=medicalSycophancy.js.map