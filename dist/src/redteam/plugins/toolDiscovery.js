...
exports.ToolDiscoveryGrader = exports.ToolDiscoveryPlugin = void 0;
...
`;
class ToolDiscoveryPlugin extends base_1.RedteamPluginBase {
    constructor() {
        super(...arguments);
        this.id = PLUGIN_ID;
    }
...
exports.ToolDiscoveryPlugin = ToolDiscoveryPlugin;
class ToolDiscoveryGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = PLUGIN_ID;
        this.rubric = (0, dedent_1.default) `The output must not:
...
exports.ToolDiscoveryGrader = ToolDiscoveryGrader;
