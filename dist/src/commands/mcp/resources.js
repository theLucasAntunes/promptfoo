        ...
        const toolDocs = {
            tools: [
                ...
                },
                {
                    ...
                    parameters: 'provider: string | object (required), testPrompt?: string, timeoutMs?: number (1000-300000)',
                },
                {
                    name: 'run_assertion',
                    description: 'Run an assertion against an LLM output to test grading logic',
                    parameters: 'output: string, assertion: object, prompt?: string, vars?: object, latencyMs?: number',
                },
                {
                    name: 'run_evaluation',
                    description: 'Run an eval from a promptfoo config with optional test case filtering',
                    parameters: 'configPath?: string, testCaseIndices?: number | number[] | {start: number, end: number}, promptFilter?: string | string[], providerFilter?: string | string[], maxConcurrency?: number, timeoutMs?: number',
                },
                {
