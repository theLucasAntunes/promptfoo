 ...
 * @module prompts
 */
__exportStar(require("../external/prompts/ragas"), exports);
exports.DEFAULT_GRADING_PROMPT = JSON.stringify([
    {
        role: 'system',
        content: (0, dedent_1.default) `You are grading output according to a user-specified rubric. If the statement in the rubric is true, then the output passes the test. You respond with a JSON object with this structure: {reason: string, pass: boolean, score: number}
...
exports.PROMPTFOO_FACTUALITY_PROMPT = JSON.stringify([
    {
        role: 'system',
