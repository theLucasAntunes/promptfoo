...
import type { ApiProvider, AtomicTestCase, GradingResult, Prompt, ProviderOptions, ProviderResponse, ResultFailureReason } from '../types/index';
...
export default class EvalResult {
     ...
     */
    static getCompletedIndexPairs(evalId: string): Promise<Set<string>>;
