...
const EvaluateOptionsSchema = zod_1.z.object({
    ...
    isRedteam: zod_1.z.boolean().optional(),
});
const PromptMetricsSchema = zod_1.z.object({
    ...
    tokenUsage: shared_1.BaseTokenUsageSchema,
...
const AssertionSetSchema = zod_1.z.object({
    ...
    assert: zod_1.z.array(zod_1.z.lazy(() => exports.AssertionSchema)),
...
exports.AssertionSchema = zod_1.z.object({
    ...
    contextTransform: zod_1.z.string().optional(),
});
...
exports.TestSuiteSchema = zod_1.z.object({
    ...
    defaultTest: zod_1.z
        .union([
        zod_1.z.string().refine((val) => val.startsWith('file://'), {
            message: 'defaultTest string must start with file://',
        }),
        exports.TestCaseSchema.omit({ description: true }),
    ])
        .optional(),
    // Nunjucks filters
    ...
    tracing: zod_1.z
        ...
        otlp: zod_1.z
            ...
            http: zod_1.z
                ...
                acceptFormats: zod_1.z.array(zod_1.z.string()),
            })
                .optional(),
            grpc: zod_1.z
                .object({
    ...
    tracing: zod_1.z
        ...
        otlp: zod_1.z
            ...
            http: zod_1.z
                ...
                port: zod_1.z.number().default(4318),
                host: zod_1.z.string().default('0.0.0.0'),
                acceptFormats: zod_1.z.array(zod_1.z.enum(['protobuf', 'json'])).default(['json']),
            })
                .optional(),
            grpc: zod_1.z
                .object({
                enabled: zod_1.z.boolean().default(false),
                port: zod_1.z.number().default(4317),
            })
                .optional(),
        })
            .optional(),
        ...
        storage: zod_1.z
            .object({
            type: zod_1.z.enum(['sqlite']).default('sqlite'),
...
exports.OutputFileExtension = zod_1.z.enum([
    'csv',
    'html',
    'json',
    'jsonl',
...
exports.EvalResultsFilterMode = zod_1.z.enum([
    'all',
    'failures',
    'different',
    'highlights',
